...
- 🐍 [Code Context Engine](https://github.com/elara-labs/code-context-engine) - Index your codebase so AI agents search instead of re-reading files. 94% input token savings, hybrid vector + BM25 retrieval, cross-session memory. Works with Claude Code, Cursor, VS Code, Gemini CLI, Codex.
